...
namespace SacMobileBurgman.Models.Helper
{
    public class SqlHelper : IDisposable
    {
        internal static string _connectionString = ConfigurationManager.ConnectionStrings[
                                          ConfigurationManager.AppSettings["ConnectionStringInUse"]].ConnectionString;
